...
const char* password = "masihnorak";

// Cloud iot details.
const char* project_id = "smart-0406-monitoring";
const char* location = "asia-east1";
const char* registry_id = "iot-registry";
const char* device_id = "smart-0406-monitoring";
...
const unsigned char private_key[] = {
    0x1d, 0xd0, 0xc9,0xad, 0xfc, 0x03, 0x54, 0xa3, 0xac, 0x31, 0xb8, 0x0d, 0x4d, 0x8b, 0x95,
    0xab, 0x0a, 0xa9, 0x10, 0xdc, 0x82, 0xa8, 0x1f, 0x82, 0xa6, 0xc3, 0x3a, 0xe1, 0xd5, 0x9f, 0xad, 0xf5 
    };
